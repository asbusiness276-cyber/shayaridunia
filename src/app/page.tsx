    ...
    <div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16">
        ...
        <div className="mt-10 text-center">
          <Link href="/categories" className="inline-flex items-center px-8 py-4 bg-white border-2 border-pink-100 text-pink-600 font-bold rounded-full shadow-sm hover:shadow-md hover:bg-pink-50 hover:border-pink-200 transform hover:-translate-y-1 transition-all">
            Explore All 40+ Categories <svg className="w-5 h-5 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M17 8l4 4m0 0l-4 4m4-4H3"></path></svg>
          </Link>
        </div>
      </div>
